...
#define INFO_SIZE 128 // information flash sizes (SEG_A to SEG_D)

// segment addresses of 128 byte segments
#define SEGMENT_D ((unsigned char*)0x1800)
#define SEGMENT_C ((unsigned char*)0x1800+128)
#define SEGMENT_B ((unsigned char*)0x1800+256)
// #define SEGMENT_A ((unsigned char*)0x1800+384) // NOTE: Contains chip calibarion data, do not change or erase (the protection bit should prevent this happening)
